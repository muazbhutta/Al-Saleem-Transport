  ...
  return (
    <>
      ...
      <section className="section bg-cream">
        <div className="container grid gap-10 lg:grid-cols-[1.4fr_1fr]">
          <Reveal className="prose-guide flex flex-col gap-5">
            {story.map((para, i) => (
              <p key={i} className="text-base leading-relaxed text-navy-600">
                {para}
              </p>
            ))}
          </Reveal>
            ...
            <div className="card flex flex-col gap-4 bg-navy text-cream-100">
              ...
              <dl className="mt-2 flex flex-col gap-3 text-sm">
                <div className="rounded-xl bg-white/5 p-3 ring-1 ring-white/10">
                  <dt className="text-cream-100/60">{t('licenseLabel')}</dt>
                  <dd className="font-semibold text-gold-light" dir="ltr">{site.licenseNo}</dd>
                </div>
                <div className="rounded-xl bg-white/5 p-3 ring-1 ring-white/10">
                  <dt className="text-cream-100/60">{t('unifiedLabel')}</dt>
                  <dd className="font-semibold text-gold-light" dir="ltr">{site.unifiedNationalNo}</dd>
                </div>
                <div className="rounded-xl bg-white/5 p-3 ring-1 ring-white/10">
                  <dt className="text-cream-100/60">{t('coverageLabel')}</dt>
                  <dd className="font-semibold text-cream-100">{tc('coverageShort')}</dd>
                </div>
              </dl>
            </div>
          </Reveal>
      ...
      <section className="bg-white py-16">
        <div className="container">
          <Reveal>
            <div className="mx-auto max-w-3xl rounded-3xl bg-gradient-to-br from-teal to-teal-dark px-6 py-12 text-center text-cream-100 shadow-card sm:px-12">
              <h2 className="text-2xl text-cream-100 sm:text-3xl">{t('missionTitle')}</h2>
              <p className="mt-4 text-lg leading-relaxed text-cream-100/90">{t('mission')}</p>
            </div>
          </Reveal>
        </div>
      </section>
      ...
      <section className="section bg-cream">
        <div className="container flex flex-col gap-10">
          <Reveal>
            <h2 className="text-center text-3xl sm:text-4xl">{t('valuesTitle')}</h2>
          </Reveal>
              ...
              return (
                <Reveal key={key} delay={i * 0.05}>
                  <div className="card h-full text-center">
                    <span className="mx-auto mb-4 inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-maroon/10 text-maroon">
